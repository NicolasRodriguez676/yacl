...
function(stm32_get_cores CORES)
    ...
    if(ARG_CHIP)
        # : I don't get why stm32_get_chip_info is called in stm32_get_cores
        stm32_get_chip_info(${ARG_CHIP} FAMILY ARG_FAMILY TYPE ARG_TYPE DEVICE ARG_DEVICE)
    elseif(ARG_FAMILY AND ARG_DEVICE)
        # : I don't get why stm32_get_chip_type is called in stm32_get_cores
    ...
    #  following is the only part really used by FindCMSIS. Maybe a cleanup is needed
    if(${ARG_FAMILY} STREQUAL "H7")
...
function(stm32_get_memory_info)
    ...
    elseif(INFO_STACK)
        ...
        set(ORIGIN ${RAM_ORIGIN}) #: Real stack pointer?
    elseif(INFO_HEAP)
        if (RAM STREQUAL "2K")
            set(SIZE 0x100)
        else()
        ...
        set(ORIGIN ${RAM_ORIGIN}) #: Real heap pointer?
    endif()
